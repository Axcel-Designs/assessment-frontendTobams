...
export default function Training() {
  return (
    <section className='grid gap-12 xl:gap-30 xl:p-16 text-[#151515]'>
      {trainingData.map((training, i) => (
        <div key={i} className={`flex flex-col xl:flex-row xl:max-h-101.25 p-6 xl:p-0 gap-6 xl:gap-16 rounded-lg items-center justify-center ${i % 2 === 1 ? 'xl:flex-row-reverse ' : ''}`}>
          ...
          <div className="order-3 xl:gap-5.25 xl:order-0 grid xl:max-h-101.25">
            ...
            <div className='grid xl:gap-4.75'>
          ...
          <div className="relative w-full aspect-square xl:h-full xl:w-full xl:min-w-150 order-2 xl:order-1 rounded-lg overflow-hidden rounded-tl-[56px] rounded-tr-3xl rounded-br-[23px] rounded-bl-xl xl:aspect-auto">
